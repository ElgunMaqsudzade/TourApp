...
@Component
public class OfferCapCacheImpl implements OfferCapCache {
    ...
    public OfferCapCacheImpl(SchedulerExecutor sch, OfferService offerService, RedisTemplate<String, Object> template, BotConfig config) {
        this.offerService = offerService;
        this.hashOps = template.opsForHash();
        this.HASH_KEY = config.getRedis().getOfferCap();
        this.sch = sch;
